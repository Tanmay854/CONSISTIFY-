  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden" style={{ height: "100dvh" }}>
      ...
      >
        ...
        {mode === "overview" && (
          <Overview coverRef={coverRef} scrollRef={overviewScrollRef} book={book} coverLayoutId={dismissDown ? undefined : coverLayoutId} similar={similar} showBackdrop={!dismissDown} onQuiz={() => goMode("quiz")} onListen={() => goMode("audio")} onOpenPage={openSummaryAt} onBuy={() => openAmazon(book.amazon_url)} />
        )}
